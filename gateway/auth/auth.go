...
func sendEmail(to, magicLink string) error {
	...
	body := map[string]interface{}{
		...
		"html": fmt.Sprintf(`
<div style="font-family:sans-serif;max-width:480px;margin:40px auto;padding:0 20px">
  <h2 style="font-size:20px;font-weight:600;color:#111">Sign in to TAO Gateway</h2>
  <p style="color:#555;font-size:14px;line-height:1.6">
    Click the button below to sign in. This link expires in 15 minutes.
  </p>
  <a href="%s" style="display:inline-block;margin:24px 0;padding:12px 24px;background:#111;color:#fff;text-decoration:none;border-radius:8px;font-size:14px;font-weight:600">
    Sign in to TAO Gateway →
  </a>
